...
* 
* Converts uint_t to hex to a 2 or 8 digit hex value.
*
* @param i a value that is converted to a 2 or 8 digit hex
* 
* @return a string with exactly 2 or 8 hex digits representing the 8 or 32 bits.
* 
*@{
********************************************************************************/
